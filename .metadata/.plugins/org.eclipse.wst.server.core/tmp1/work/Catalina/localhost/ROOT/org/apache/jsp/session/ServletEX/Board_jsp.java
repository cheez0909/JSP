 ...
 * Generated at: 2023-11-22 06:45:33 UTC
...
public final class Board_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1700440452651L));
    _jspx_dependants.put("jar:file:/C:/app/hellojsp/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/1103/WEB-INF/lib/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153352682000L));
    _jspx_dependants.put("/session/ServletEX/Header.jsp", Long.valueOf(1700631165723L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css\" style=\"user-select: auto;\">\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      ...
      out.write("	let searchField = '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pages.criteria.searchField}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("'; // 왜 안나오지..\r\n");
      out.write("	console.log(\"searchField : \", searchField);\r\n");
      out.write("	let options = searchForm.searchField.options;\r\n");
      out.write("	\r\n");
      ...
      out.write("		\r\n");
      out.write("		\r\n");
      out.write("	// select 요소의 옵션이 selected 속성을 부여\r\n");
      out.write("	for(let i=0; i<searchForm.searchField.options.length; i++){\r\n");
      out.write("		console.log(searchForm.searchField.options[i].value);\r\n");
      out.write("		if(searchForm.searchField.options[i].value==searchField){\r\n");
      out.write("			searchForm.searchField.options[i].setAttribute(\"selected\", \"selected\")\r\n");
      out.write("		}\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write(" // 게시글의 넘버만 받아오면됨\r\n");
      out.write(" // 페이지 넘버는 이미 있음\r\n");
      out.write("function goDetail(num){\r\n");
      out.write("	// 파라미터로 넘어온 페이지번호를 searchForm에 pageNo에 입력\r\n");
      out.write("	searchForm.action='/session/ServletEX/detail';\r\n");
      out.write("	searchForm.num.value = num;\r\n");
      out.write("	searchForm.submit();\r\n");
      out.write("	// location.href=\"/boardList\";\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write(" // 폼을 전송(요청)한다\r\n");
      out.write(" function forSubmit(){\r\n");
      out.write("	 // 1. 폼을 선택 - 폼의 이름을 불러준다.\r\n");
      out.write("	 // 2. 폼 요소를 선택 - 폼.요소이름\r\n");
      out.write("	 searchForm.pageNo.value  = '페이지 번호';\r\n");
      out.write("	 \r\n");
      out.write("	 // 3. 폼 전송하기 - form의 action속성에 정의된 url을 요청한다.\r\n");
      out.write("	 // 폼안에 요소들을 파라미터로 서버에 전달\r\n");
      out.write("	 searchForm.submit();\r\n");
      out.write("	 \r\n");
      out.write(" }\r\n");
      out.write("\r\n");
	...
	if(request.getAttribute("page")!=null && !"".equals(request.getAttribute("page"))){
      ...
      out.write("    \r\n");
      out.write("    <!-- 검색폼 : 테이블로 만들 수 있음-->\r\n");
      out.write("    <!--  페이지 번호 같이 넣어주기!!!! -->\r\n");
      out.write("    \r\n");
      out.write("      	<form name = \"searchForm\" class=\"d-flex\" style=\"user-select: auto;\" action=\"/boardList\">\r\n");
      ...
      out.write("\">\r\n");
      out.write("      	num : <input type=\"text\" name = \"num\">\r\n");
      out.write("      	<select class=\"form-search me-sm-2\" name = \"searchField\" id=\"exampleSelect1\" style=\"user-select: auto;\">\r\n");
      out.write("        <option value=\"title\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pages.criteria.searchField eq 'title' ? 'selected' : ''}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">제목</option>\r\n");
      out.write("        <option value=\"id\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pages.criteria.searchField eq 'id' ? 'selected' : ''}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">작성자</option>\r\n");
      out.write("        <option value=\"content\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pages.criteria.searchField eq 'content' ? 'selected' : ''}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">내용</option>\r\n");
      out.write("      	</select>\r\n");
      out.write("      	\r\n");
      out.write("        <input class=\"form-control me-sm-2\" name = \"searchWord\" value = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pages.criteria.searchWord}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" type=\"search\" placeholder=\"Search\" style=\"user-select: auto;\">\r\n");
      out.write("        <button class=\"btn btn-secondary my-2 my-sm-0\" type=\"submit\" style=\"user-select: auto;\">Search</button>\r\n");
      out.write("        </form>\r\n");
      out.write("  </div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("      </thead>\r\n");
      out.write("      \r\n");
      out.write("      <!-- 리스트가 비어있다면 데이터가 없습니다 출력 -->\r\n");
      out.write("      <!-- 리스트가 비어있지 않으면 목록을 출력 -->\r\n");
      out.write("      \r\n");
      out.write("      ");
      ...
      out.write("검색어를 유지하기 위해 searchForm을 전송하는 gopage함수를 생성하였다.\r\n");
      out.write("\r\n");
      out.write(" -->\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /session/ServletEX/Board.jsp(225,8) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /session/ServletEX/Board.jsp(228,8) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /session/ServletEX/Board.jsp(264,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty dto }", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      // /session/ServletEX/Board.jsp(264,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f2.setVar("dto");
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /session/ServletEX/Board.jsp(293,6) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${empty boarddto}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      // /session/ServletEX/Board.jsp(293,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /session/ServletEX/Board.jsp(296,6) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f4, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /session/ServletEX/Board.jsp(297,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("num");
      // /session/ServletEX/Board.jsp(297,6) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/session/ServletEX/Board.jsp(297,6) '${boarddto}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${boarddto}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("      	<tr>\r\n");
            out.write("                <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${num.num }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            ...
            out.write('"');
            out.write('>');
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${num.title }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</a></td>\r\n");
            out.write("                ");
            out.write("\r\n");
            out.write("                <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${num.id }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("				<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${num.postdate }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("				<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${num.visitcount }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("		</tr>\r\n");
            out.write("      ");
